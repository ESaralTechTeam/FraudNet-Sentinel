...
class ComplaintDB:
    ...
    def create(data: dict) -> str:
        ...
        beneficiary_id = data.get('subject_beneficiary_id')
        if not beneficiary_id or beneficiary_id == '':
            beneficiary_id = f"BEN-{random.randint(100000, 999999)}"
            print(f"Generated fallback beneficiary_id in ComplaintDB.create: {beneficiary_id}")
        ...
        item = {
            ...
            'subject_beneficiary_id': beneficiary_id,  # Store as subject_beneficiary_id
            'beneficiary_id': beneficiary_id,  # Also store as beneficiary_id for consistency
        ...
        print(f"✅ ComplaintDB.create: {complaint_id} with beneficiary_id: {beneficiary_id}")
